...
const publishers = [
  ...
  },
  {
    ...
    feedUrl:
      "https://www.reddit.com/r/MachineLearning/.rss?path=%2Fdiscover%2Ftopic%2Ftech-news-trends%2Fdata-science-ml",
  ...
  },
  {
    ...
    payWall: false,
    publisherUrl: "https://engineering.hashnode.com",
  ...
  },
  {
    name: "StackToHeap",
    payWall: false,
    publisherUrl: "https://stacktoheap.com",
    feedUrl: "https://stacktoheap.com/feed.xml",
    isActive: "active",
    feedType: "xml",
    primaryTag: "Tech",
    frequency: "6 hours",
  ...
  if (env === "production") {
    for (const publisher of publishers) {
      const updateCommand = new UpdateItemCommand({
        ...
        UpdateExpression:
          "SET isActive = :isActive, feedType = :feedType, logo = :logo, primaryTag = :primaryTag, payWall = :payWall, id = if_not_exists(id, :id)",
